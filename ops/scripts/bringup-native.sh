...
exec "$PY" -B "${TAVERN_DATA_ROOT:-$HERMES_HOME}/apps/tavern-ops/updater/liveware_integration.py" --home "${TAVERN_DATA_ROOT:-$HERMES_HOME}" --hermes-home "$HERMES_HOME" recover-existing
