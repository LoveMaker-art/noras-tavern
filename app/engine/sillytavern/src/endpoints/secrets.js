...
export class SecretManager {
    /**
     * @param {import('../workspace.js').UserDirectoryList} directories
     */
 ...
 * @param {import('../workspace.js').UserDirectoryList[]} directoriesList User directories
 */
