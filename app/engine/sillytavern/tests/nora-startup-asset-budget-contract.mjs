...
const manifest = JSON.parse(fs.readFileSync(new URL('../public/dist/nora/inline-modules.js', import.meta.url), 'utf8'));
const manifestBrotliSize = fs.statSync(new URL('../public/dist/nora/inline-modules.js.br', import.meta.url)).size;
