...
import { countOccurrences, debounce, delay, getStringHash, isOdd, isTrueBoolean, resetScrollHeight, shuffle, sortMoments, stringToRange, timestampToMoment } from './utils.js';
...
import { IMAGE_OVERSWIPE, MEDIA_DISPLAY, persona_description_positions as _persona_description_positions } from './constants.js';
...
//MARK: loadPowerUser
export async function loadPowerUserSettings(settings, data, { applyLegacyUi = true } = {}) {
...
export function loadMovingUIState() {
    // Compatibility facade for extensions that still call the legacy ST hook.
}
