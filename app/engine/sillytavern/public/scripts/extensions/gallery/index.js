 ...
 * - Preparing gallery items based on the selected character.
...
async function showCharGallery(deleteModeState = false) {
    ...
    try {
        ...
        const url = this_chid !== undefined ? getGalleryFolder(characters[this_chid]) : this_chid;
...
SlashCommandParser.addCommandObject(SlashCommand.fromProps({
    ...
    helpString: 'List images in the gallery of the current or specified character.',
}));
