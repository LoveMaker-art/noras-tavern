...
export class Popup {
     ...
     */
    async show() {
        const prepareNoraPopup = globalThis.__NORA_PREPARE_ST_POPUP__;
        if (typeof prepareNoraPopup === 'function') {
            prepareNoraPopup(this);
        }
 ...
 */
export async function callGenericPopup(content, type, inputValue = '', popupOptions = {}) {
